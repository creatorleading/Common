...
import com.app.common.okgo.entity.SimpleResponse;
import com.app.common.okgo.utils.Convert;
...
public class JsonConvert<T> implements Converter<T> {
    ...
    private T parseClass(Response response, Class<?> rawType) throws Exception {
     ...
     /*   } else if (rawType == JsonElement.class) {
            String str = body.string();
            return (T) GsonUtils.jsonElementFrom(str);*/
        } else {
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != BaseResponeEntity.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                BaseResponeEntity lzyResponse = Convert.fromJson(jsonReader, type);
                response.close();
