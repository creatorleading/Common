...
public class ScreenUtils {
     ...
     * @return
     */
    public static float getScreenRateWithoutStatusBar(Context context){
        float W = getScreenWidth(context);
        float H = getScreenHeight(context)-getStatusBarHeight(context);
        return (H/W);
    }
